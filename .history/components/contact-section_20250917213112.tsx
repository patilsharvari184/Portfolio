    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                ...
                to hear from you. I'm always excited to work on innovative projects that make a difference.
              </p>
            </div>
              ...
              {[
                {
                  icon: Mail,
                  title: "Email",
                  value: "sharvari.patil@example.com",
                  color: "from-blue-500/20 to-cyan-500/20",
                },
                { icon: Phone, title: "Phone", value: "+91 98765 43210", color: "from-green-500/20 to-emerald-500/20" },
                { icon: MapPin, title: "Location", value: "Mumbai, India", color: "from-purple-500/20 to-pink-500/20" },
              ].map((item, index) => (
                <div
                  key={item.title}
                  className={`flex items-center space-x-4 group transition-all duration-500 delay-${index * 100} ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
                >
                  <div
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                {[
                  { icon: Linkedin, href: "https://linkedin.com/in/sharvari-patil", color: "hover:bg-blue-600" },
                  { icon: Github, href: "https://github.com/sharvari-patil", color: "hover:bg-gray-800" },
                  { icon: Mail, href: "mailto:sharvari.patil@example.com", color: "hover:bg-accent" },
                ].map((social, index) => (
                  <a
                    key={index}
                    href={social.href}
          ...
          <Card
            className={`transition-all duration-1000 delay-500 hover:scale-105 border-0 bg-gradient-to-br from-background/90 to-background/70 backdrop-blur-sm relative overflow-hidden ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
          >
