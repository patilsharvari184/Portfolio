      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground animate-fade-in-up">Experience</h2>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto animate-fade-in-up delay-700"></p>
        </div>
