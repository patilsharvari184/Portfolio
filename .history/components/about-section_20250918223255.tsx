...
const stats = [
  { number: "10+", label: "Projects Completed", link: "https://github.com/patilsharva" },
  { number: "15+", label: "Technologies Mastered" },
  { number: "10+", label: "Certificates Earned", link: "https://www.linkedin.com/in/sharvari-patil-444537224/details/certifications/" },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-6 animate-fade-in-right">
            ...
            {/* Know More Button Card */}
            {/* <Card className="flex items-center justify-center p-6 hover-lift border-2 hover:border-accent/50 transition-all duration-500">
              <CardContent className="relative z-10 flex flex-col items-center justify-center"> */}
                <Button
                  variant="default"
                  className="bg-accent text-accent-foreground hover:bg-accent/90 transition-all duration-300 relative z-10 flex flex-col items-center justify-center w-full mt-4"
                  onClick={() => window.open("https://www.linkedin.com/in/sharvari-patil-444537224/", "_blank")}
                >
                  Know More
                </Button>
              {/* </CardContent>
