...
const certifications = [
  {
    ...
    icon: <SiGoogle className="text-red-500 w-6 h-6" />,
  ...
  },
  {
    ...
    icon: <SiAmazonaws className="text-orange-500 w-6 h-6" />,
  ...
  },
  {
    ...
    // icon: "🛡️",
    icon: "AiFillSecurityScan" /*Security icon*/,
