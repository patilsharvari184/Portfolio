      ...
      <CardContent className="p-4 relative z-10">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3
              className={`font-bold text-foreground mb-1 transition-colors duration-300 group-hover:${item.accent}`}
            >
              {item.title}
            </h3>
            <div className="flex items-center font-medium text-sm mb-2 text-muted-foreground">
