        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-6 animate-fade-in-right">
            ...
            <div className="flex items-center justify-center">
              <Button
                size="lg"
                className="group hover:scale-105 active:scale-95 glowing bg-accent hover:bg-accent/90 text-white shadow-lg transition-all duration-300 w-full py-6"
                onClick={() =window.open("https://www.linkedin.com/in/sharvari-patil-444537224/", "_blank")
    }
  >
    <span className="mr-2 h-5 w-5 flex items-center justify-center group-hover:animate-bounce">
      <ArrowRight />
    </span>
    Know More
  </Button>
