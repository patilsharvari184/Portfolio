...
import { SiGoogle, SiMicrosoft, SiAmazonaws, SiCoursera } from "react-icons/si"
import { FaCisco, FaUipath } from "react-icons/fa"
...
const certifications = [
  {
    ...
    icon: <img src="/google-logo.png" alt="Google" className="w-7 h-7" />,
  ...
  },
  {
    ...
    // icon: "☁️",
    icon: <img src="/aws-171.png" alt="AWS" className="w-7 h-7" />,
  ...
  },
  {
    ...
    // icon: "🔐",
    icon: <img src="/cisco-logo-png.png" alt="Cisco" className="w-7 h-7" />,
  ...
  },
  {
    ...
    // icon: "🛡️",
    icon: <img src="/AICTE logo.png" alt="AICTE" className="w-7 h-7" />,
  ...
  },
  {
    ...
    // icon: "📊",
    icon: <img src="/foragelogo.png" alt="Forage" className="w-7 h-7" />,
  ...
  },
  {
    ...
    // icon: "📈",
    icon: <img src="/Google-Analytics-Logo.png" alt="Google" className="w-7 h-7" />,
  ...
  },
  {
    ...
    // icon: "🔗",
    icon: <img src="/postman.png" alt="Postman" className="w-7 h-7" />,
  ...
  },
  {
    ...
    // icon: "🤖",
    icon: <img src="/uipath-logo.png" alt="UiPath" className="w-7 h-7" />,
