  ...
  return (
    <footer className="bg-primary text-primary-foreground py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-primary-foreground/20 mt-10 pt-10">
          <div className="flex justify-center"> {/* align © {currentYear} Sharvari Patil. All rights reserved. to center */}
            <p className="text-sm text-primary-foreground/60 text-center">© {currentYear} Sharvari Patil. All rights reserved.</p>
