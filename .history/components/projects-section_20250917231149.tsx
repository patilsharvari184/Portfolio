...
const projects = [
  {
    title: "ChatDoc – AI Multi-LLM Document Assistant",
    ...
    image: "/placeholder.svg?key=clgse",
    github: "#",
    demo: "#",
    category: "AI/ML",
  },
  {
    ...
    image: "/placeholder.svg?key=D:\Downloads\sharvari-portfolio\public\face-recognition-attendance-system-interface.jpg",
    github: "#",
    demo: "#",
  ...
  },
  {
    ...
    image: "/placeholder.svg?key=j4glz",
    github: "#",
    demo: "#",
    category: "NLP",
  },
  {
    ...
    image: "/placeholder.svg?key=7yfci",
    github: "#",
    demo: "#",
    category: "Computer Vision",
  },
  {
    ...
    image: "/placeholder.svg?key=5s024",
    github: "#",
    demo: "#",
    category: "NLP",
  },
  {
    ...
    image: "/placeholder.svg?key=4w945",
    github: "#",
    demo: "#",
    category: "Research",
  },
    ...
    <section id="projects" className="py-16 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-accent via-primary to-accent mx-auto mb-6 animate-expand"></div>
