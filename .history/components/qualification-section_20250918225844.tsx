...
export default function QualificationSection() {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            const index = idxStr ? Number.parseInt(idxStr, 10) : NaN
  ...
  const CompactCard = ({ item, index, icon: Icon }: { item: any; index: number; icon: any }) => {
    ...
    return (
      ...
      >
        <Card className="bg-gradient-to-br from-background/95 to-background/70 backdrop-blur-sm border border-muted/30 shadow-md hover:shadow-xl transition-all duration-500 relative overflow-hidden rounded-2xl">
          <div
          ...
          <CardContent className="p-5 relative z-10">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center text-accent font-medium text-sm mb-1">
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  {item.skills.length > 3 && (
                    <Badge variant="outline" className="text-xs px-2 py-0">+{item.skills.length - 3}</Badge>
                  )}
                </div>
              </div>
            </div>
  ...
  return (
    <section id="qualification" className="py-20 relative overflow-hidden">
