...
const roles = ["Research Intern", "AI & ML Enthusiast", "Full-Stack Developer", "Data Scientist"]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
              I build intelligent systems that solve real-world problems using AI, ML, and full-stack development. Let's
              create something amazing together!
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center pt-8">
              <Button size="lg" className="group hover-lift glowing bg-accent hover:bg-accent/90 text-white shadow-lg">
            ...
            <div className="flex justify-center lg:justify-start space-x-6 pt-8">
              <a
                href="https://linkedin.com/in/sharvari-patil"
                target="_blank"
              ...
              <a
                href="https://github.com/sharvari-patil"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-accent transition-all duration-300 hover-scale"
              >
            ...
            <div className="relative">
              ...
              <div className="relative z-10 floating">
                <div className="w-72 h-72 rounded-full overflow-hidden border-4 border-accent/50 shadow-2xl hover-scale glowing">
                  <img
                    src="/professional-headshot-of-young-woman-ai-researcher.jpg"
                    alt="Sharvari Patil"
