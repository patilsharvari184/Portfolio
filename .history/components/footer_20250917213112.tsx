        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-sm text-primary-foreground/80">sharvari.patil@example.com</p>
              <p className="text-sm text-primary-foreground/80">Mumbai, India</p>
            </div>
            <div className="flex space-x-4 pt-2">
              ...
              <a
                href="mailto:sharvari.patil@example.com"
                className="text-primary-foreground/80 hover:text-accent transition-colors hover-lift"
              >
